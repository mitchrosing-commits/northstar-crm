...
describe("Deal Reporting v1", () => {
  ...
  it("adds a simple server-rendered reports page without charts or builders", () => {
    ...
    expect(reportsPage).toContain("const viewOpenDealsLabel = \"View open deals from reports\"");
    expect(reportsPage).toContain("aria-label={viewOpenDealsLabel}");
    expect(reportsPage).toContain("title={viewOpenDealsLabel}");
