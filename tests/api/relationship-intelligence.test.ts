...
describe("Relationship Intelligence for contact profiles", () => {
  ...
  it("renders and edits the Relationship Brief from the contact detail page", () => {
    ...
    expect(relationshipBriefPanel).toContain("Relationship Brief sensitivity guidance");
    ...
    expect(relationshipBriefPanel).toContain("relationshipBriefSavedSections");
    ...
    expect(relationshipBriefPanel).toContain("No Relationship Brief changes match these filters.");
    expect(relationshipBriefPanel).toContain("No Relationship Brief history has been recorded yet.");
